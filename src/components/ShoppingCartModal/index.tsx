...
import { closeCart, removeItem } from "../../features/shoppingCart/shoppingCartSlice"
...
function ShoppingCartModal () {
    ...
    const cartTotal = useSelector((state:RootReducer)=>state.shoppingCart.cartTotal)
    const dispatch = useDispatch()


    return (
        <>
        {isOpen && <CartBackdrop onClick={() => {dispatch(closeCart())}}>
